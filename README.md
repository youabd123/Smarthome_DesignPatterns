...
Den gör att **Program.cs** inte behöver prata med alla klasser direkt. Istället används enkla metoder som `TurnOnLamp()` och `Replay()`, vilket gör koden renare och lättare att använda.
...
Det säkerställer att det bara finns en logger i hela systemet. Alla delar använder samma instans, vilket gör loggningen konsekvent och centraliserad.
